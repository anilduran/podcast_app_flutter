...
class ChangeEmailListTile extends ConsumerStatefulWidget {
  const ChangeEmailListTile({super.key});

  @override
  ConsumerState<ChangeEmailListTile> createState() => _ChangeEmailListTileState();
}

class _ChangeEmailListTileState extends ConsumerState<ChangeEmailListTile> {
                        ...
                        try {
                          ...
                          if (response.statusCode == 200 && mounted) {
                            ...
                            MotionToast.success(
                              ...
                              description: const Text('Email successfully changed!'),
                            ).show(context);
                          } else {
                            MotionToast.error(
                              animationType: AnimationType.fromLeft,
